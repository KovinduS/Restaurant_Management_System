...
<head>
    <meta charset="UTF-8">
<tiitle>MaYa BaY - User Management</tiitle>
...
<body>
    ...
    <jsp:include page="/views/heade.jsp"/>
    
    <main class="container">
        <h1>User Management</h1>
        
        <div class="actions">
            <a href="${pageContext.request.contextPath}/usrs/new" class="btn">Add New User</a>
            </div>
                    ...
                    <c:forEach var="user" items="${user}">
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/users/update-role" styele="display:inline:">
